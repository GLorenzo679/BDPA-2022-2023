...
public class SparkDriver {
	...
	public static void main(String[] args) {
		...
		inputPath = "ex_01_logistic_regression/data/ReviewsNewfile.csv";
		...
		JavaRDD<LabeledPoint> dataRDD=labeledData.map(x -> {
			...
			if(helpfulness <= 0.9)
				return new LabeledPoint(0.0, Vectors.dense(textLenght));
			else
				return new LabeledPoint(1.0, Vectors.dense(textLenght));
		}); 
