...
public class SparkDriver {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		JavaPairDStream<String, Integer> relevantHashtags = hashtagFreq.filter((Tuple2<String, Integer> element) -> {
			if (element._2().intValue() >= 100)
				return true;
			else
				return false;
		});

		JavaPairDStream<Integer, String> relevantHashtagsSorted = relevantHashtags
		...
		relevantHashtagsSorted.print();
		relevantHashtagsSorted.dstream().saveAsTextFiles(outputPathPrefix, "");
